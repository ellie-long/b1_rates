...
awk '$1!="#" {print $1,$1*$6,$1*$7}' $file0 > temp_xb1_stat
awk '$1!="#" {print $1,$1*$6,$1*sqrt($7*$7+$8*$8)}' $file0 > temp_xb1_tot
...
awk '$1==1 && $2!=0.0 {print $2,$6}' $file1 > temp_model_nosea_cteq
awk '$1==1 && $2!=0.0 {print $2,$10}' $file1 > temp_model_sea_cteq
awk '$1==2 && $2!=0.0 {print $2,$6}' $file1 > temp_model_nosea_mrst
awk '$1==2 && $2!=0.0 {print $2,$10}' $file1 > temp_model_sea_mrst
awk '$1==3 && $2!=0.0 {print $2,$6}' $file1 > temp_model_nosea_mstw
awk '$1==3 && $2!=0.0 {print $2,$10}' $file1 > temp_model_sea_mstw
...
awk '$1!=0.9 {print $2,$2*$3}' $file2 > temp_model_miller
awk '$1==3 && $2<=0.6 {print $2,$5}' $file2 > temp_model_miller_Azz


file3="../../models/output/b1model_sargsian.dat"
awk '$1==1 && $2>=0.15 {print $2,$4}' $file3 > temp_model_sargsian_vn
awk '$1==1 && $2>=0.15 {print $2,$6}' $file3 > temp_model_sargsian_lc

file5="../../models/output/b1model_bacchetta.dat"
awk '$1==1 && $2!=0.0{print $2,$4}' $file5 > temp_model_bacchetta_low
awk '$1==1 && $2!=0.0{print $2,$5}' $file5 > temp_model_bacchetta_up
...
awk '$1==3 {print $2,0,$2*$11}' $file4 > temp_hrs_stat
awk '$1==4 {print $2,0,$2*$11}' $file4 > temp_solid_stat
awk '$1==5 {print $2,0,$2*$11}' $file4 > temp_bb_stat
awk '$1==6 {print $2,0,$2*$11}' $file4 > temp_sbs_stat
...
awk '$1==3 {print $2,0,$2*sqrt($11*S11)}' $file4 > temp_hrs_tot
awk '$1==4 {print $2,0,$2*sqrt($11*S11)}' $file4 > temp_solid_tot
awk '$1==5 {print $2,0,$2*sqrt($11*S11)}' $file4 > temp_bb_tot
awk '$1==6 {print $2,0,$2*sqrt($11*S11)}' $file4 > temp_sbs_tot
...
awk '$1==2 && $5!="NaN" {print $2,0,$3,$2*$5}' $file7 > temp_shms_stat
awk '$1==2 && $5!="NaN" {print $2,0,$3,$2*$5}' $file7 > temp_shms_tot
...
xmgrace \
		...
		-settype xy		-block temp_hms_q2				-graph 5 -bxy 1:2 \
		-settype xy		-block temp_shms_q2				-graph 5 -bxy 1:2 \
