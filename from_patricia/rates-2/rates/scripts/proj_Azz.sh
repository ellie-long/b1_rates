...
file4="../../models/output/Azz_sargsian.dat"
awk '{print $1,-1.5*$3}' $file4 > model_sargsian_vn
awk '{print $1,-1.5*$4}' $file4 > model_sargsian_lc
#file4="../../models/output/b1model_sargsian.dat"
#awk '$2>=0.150 {print $2,-1.5*$5}' $file4 > model_sargsian_vn
#awk '$2>=0.150 {print $2,-1.5*$7}' $file4 > model_sargsian_lc

file3="../output/rates.out"
awk '$1==1 {print $3,0.0,1.5*$7}' $file3 > hms_stat
awk '$1==2 {print $3,-0.005,1.5*$7}' $file3 > shms_stat
#awk '$8!=0.0 {print $3,0.0,1.5*$7}' $file3 > shms_stat
awk '$1==2 {print $3,$15}' $file3 > syst
...
awk '$1==1 {print $2,0.0,1.5*$9}' $file4 > hms_stat
awk '$1==2 {print $2,0.0,1.5*$9}' $file4 > shms_stat
#awk '$8!=0.0 {print $3,0.0,1.5*$7}' $file3 > shms_stat
#awk '$1==2 {print $3,$15}' $file3 > syst
awk '{print $2,1.5*$13}' $file4 > syst
