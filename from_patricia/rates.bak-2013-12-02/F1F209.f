...
c      implicit none
c      integer iq,iw
c      real*8 q2,w2,F1n,F2n,r,F1p,F2p,F1d,F2d,F1c,F2c
c      real*8 f1dqe, f2dqe, nu, x, am/0.9383/, F1be, F2be,rbe

c      do iq=1,2
c       q2 = 1.0 * iq
c       do iw=1,5
c        w2 = 1. + 0.5*iw
c        nu = (w2 - am**2 + q2) / 2. / am
c        x = q2 / 2. / am / nu
c        call F1F2IN09(0.D0, 1.D0, q2, w2, F1n, F2n,r)
c        call F1F2IN09(1.D0, 1.D0, q2, w2, F1p, F2p,r)
c        call F1F2IN09(1.D0, 2.D0, q2, w2, F1d, F2d,r)
c        call F1F2IN09(4.D0, 9.D0, q2, w2, F1be, F2be,rbe)
c        write(6,'(10f7.3)') q2,w2,x,f2n,f2p,f2d,
c     >    f1p,f1be,r,rbe
c       enddo
c      enddo
c      do iq=1,3
c        q2 = 1.0 * iq
c        w2 = am**2
c        call F1F2QE09(1.D0, 2.D0, q2, w2, F1dqe, F2dqe)
c        write(6,'(3f8.3)') q2, F1dqe, F2dqe
c      enddo
