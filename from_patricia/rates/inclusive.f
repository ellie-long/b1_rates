...
C-------------------------------------------------------
     ...
     &        dged,
     &dgw2d,rel,gp2,cross_section,uet
...
***************************************************************
  ...
  103 FORMAT(3f8.4,1x,8e11.3,f8.4,8e11.3,f10.0)
      RETURN
      END
C..........................
C======================================================================
...
1     CONTINUE                                                          !ZVE00930
      ...
      GO TO 2                                                           !ZVE00980
3     DN56 = (RN(N)+(RN(N+1)-RN(N))/(P(N+1)-P(N))*(PY-P(N)))/0.197328**3!ZVE00990
     */6.505547                                                         !ZVE01000
      RETURN                                                            !ZVE01010
2     CONTINUE                                                          !ZVE01020
      DN56 = 0.                                                         !ZVE01030
...
1     CONTINUE                                                          !ZVE01220
      ...
      GO TO 2                                                           !ZVE01270
3     DP56 = (RP(N)+(RP(N+1)-RP(N))/(P(N+1)-P(N))*(PY-P(N)))/0.197328**3!ZVE01280
     */5.772066                                                         !ZVE01290
      RETURN                                                            !ZVE01300
2     CONTINUE                                                          !ZVE01310
      DP56 = 0.0                                                        !ZVE01320
...
C  *******************************                                      !A1505990
      ...
      DATA C/1.0741163,0.75531124,3.3506491,1.7447015,3.5102405,1.040004!A1506060
     ...
     *0.0096701919,-0.035256748,3.5185207,-0.59993696,4.7615828,0.411675!A1506090
     *89/                                                               !A1506100
      B=0.                                                              !A1506110
