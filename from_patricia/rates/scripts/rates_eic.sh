...
xmgrace \
		...
		-settype xydxdy		-block temp_eic_azz_stat		-graph 3 -bxy 1:2:3:4 \
...
# NOTE TO FUTURE SELF: The below box was uncommented to just show the Azz plot, likely to make it quicker to edit in Inkscape
# Note made 6/25/2019
