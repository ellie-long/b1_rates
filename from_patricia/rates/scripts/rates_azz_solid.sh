...
awk '$1==2 && $5!="NaN" {print $2-$3,-1.35,"\n"$2-$3,-1.35+sqrt($9*$9)"\n"$2+$3,-1.35+sqrt($9*$9),"\n"$2+$3,-1.35}' $file7 > temp_shms_azz_sys_bar_big_offset
awk '$1==2 && $5!="NaN" {print $2-$3,-0.025,"\n"$2-$3,-0.025+sqrt($9*$9)"\n"$2+$3,-0.025+sqrt($9*$9),"\n"$2+$3,-0.025}' $file7 > temp_shms_azz_sys_bar_small_offset
awk '$1==2 && $5!="NaN" {print $2-$3,-0.009,"\n"$2-$3,-0.009+$10"\n"$2+$3,-0.009+$10,"\n"$2+$3,-0.009}' $file7 > temp_shms_b1_sys_bar
...
#gracebat -hdevice PNG -printfile b1_rates_solid.png \
xmgrace \
		...
		-settype xydy		-block b1_pac40_b1_tot				-graph 0 -bxy 1:2:4 \
		-settype xydy		-block b1_pac40_b1_stat				-graph 0 -bxy 1:2:4 \
		-settype xydxdy		-block temp_shms_tot				-graph 0 -bxy 1:2:3:4 \
		-settype xydy		-block temp_shms_stat				-graph 0 -bxy 1:2:4 \
		...
		-settype xydy		-block b1_pac40_azz_tot				-graph 3 -bxy 1:2:4 \
		-settype xydy		-block b1_pac40_azz_stat			-graph 3 -bxy 1:2:4 \
		-settype xydxdy		-block temp_shms_azz_tot			-graph 3 -bxy 1:2:3:4 \
		-settype xydxdy		-block temp_shms_azz_stat			-graph 3 -bxy 1:2:3:4 \
		-settype xy     	-block temp_shms_azz_sys_bar_small_offset	-graph 3 -bxy 1:2 \
		...
		-p /home/ellie/physics/b1/b1_rates/from_patricia/rates/scripts/Azz_proj_hms_shms3.par -noask 
#		-p /home/ellie/physics/b1/b1_rates/from_patricia/rates/scripts/Azz_proj_hms_shms.par -noask 


#gracebat -hdevice PNG -printfile Azz_rates_solid.png \
xmgrace \
		...
		-settype xydxdy		-block pac44_azz_s1_tot				-graph 3 -bxy 1:2:3:4 \
		-settype xydxdy		-block pac44_azz_s1_stat			-graph 3 -bxy 1:2:3:4 \
		-settype xydxdy		-block temp_shms_azz_tot			-graph 3 -bxy 1:2:3:4 \
		-settype xydxdy		-block temp_shms_azz_stat			-graph 3 -bxy 1:2:3:4 \
	        -settype xy     	-block temp_shms_azz_sys_bar_big_offset		-graph 3 -bxy 1:2 \
		-settype xy		-block temp_thmin_hms				-graph 4 -bxy 1:2 \
		-settype xy		-block temp_thmin_shms				-graph 4 -bxy 1:2 \
		-settype xycolor	-block temp_hms_atheta				-graph 4 -bxy 1:2:3 \
		-settype xycolor	-block temp_shms_atheta				-graph 4 -bxy 1:2:3 \
