...
#awk '$1==1 && $2!="NaN" {print $29,0,0,$11}' $file4 > temp_hms_stat
awk '$1==1 && $2!="NaN" {print $29,$10,0,$11}' $file4 > temp_hms_stat
#echo "1	100	1	1" > temp_hms_stat
#awk '$1==2 {print $2,0,$24,$11}' $file4 > temp_shms_stat
#awk '$1==2 && $2!="NaN" {print $29,0,0,$11}' $file4 > temp_shms_stat
awk '$1==2 && $2!="NaN" {print $29,$10,0,$11}' $file4 > temp_shms_stat
...
#awk '$1==1 && $2!="NaN" {print $29,0,0,sqrt($11*S11 + $14*$14)}' $file4 > temp_hms_tot
awk '$1==1 && $2!="NaN" {print $29,$10,0,sqrt($11*S11 + $14*$14)}' $file4 > temp_hms_tot
#echo "1	100	1	1" > temp_hms_tot
#awk '$1==2 {print $2,0,$24,sqrt($11*S11)}' $file4 > temp_shms_tot
#awk '$1==2 && $2!="NaN" {print $29,0,0,sqrt($11*S11 + $14*$14)}' $file4 > temp_shms_tot
awk '$1==2 && $2!="NaN" {print $29,$10,0,sqrt($11*S11 + $14*$14)}' $file4 > temp_shms_tot
...
#awk '$1==2 && $5!="NaN" {print $2-$3,-0.009,"\n"$2-$3,-0.009+$10"\n"$2+$3,-0.009+$10,"\n"$2+$3,-0.009}' $file7 > temp_shms_b1_stat_bar


echo "100	0"  > temp_shms_azz_stat_bar
echo "100	0"  > temp_shms_b1_stat_bar


#     vvvvvvvvvvv GOOD ONES vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
#awk '$1==1 && $2!="NaN" {print $29,0,0,$9}' $file4 > temp_hms_azz_stat
awk '$1==1 && $2!="NaN" {print $29,$8,0,$9}' $file4 > temp_hms_azz_stat
#echo "1	100	1	1" > temp_hms_azz_stat
#awk '$1==2 {print $2,$8,$24,$9}' $file4 > temp_shms_azz_stat
#awk '$1==2 && $2!="NaN" {print $29,0,0,$9}' $file4 > temp_shms_azz_stat
awk '$1==2 && $2!="NaN" {print $29,$8,0,$9}' $file4 > temp_shms_azz_stat
...
#awk '$1==1 && $2!="NaN" {print $29,0,0,sqrt($9*S9 + $13*$13)}' $file4 > temp_hms_azz_tot
awk '$1==1 && $2!="NaN" {print $29,$8,0,sqrt($9*S9 + $13*$13)}' $file4 > temp_hms_azz_tot
#echo "1	100	1	1" > temp_hms_azz_tot
#awk '$1==2 {print $2,$8,$24,sqrt($9*S9)}' $file4 > temp_shms_azz_tot
#awk '$1==2 && $2!="NaN" {print $29,0,0,sqrt($9*S9 + $13*$13)}' $file4 > temp_shms_azz_tot
awk '$1==2 && $2!="NaN" {print $29,$8,0,sqrt($9*S9 + $13*$13)}' $file4 > temp_shms_azz_tot
...
xmgrace \
		...
		-p b1_proj_hms_shms_spec.par -noask 
