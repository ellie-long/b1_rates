...
awk '$12!="NaN" {print $6,$17}' $file1 >> temp_sigma_li_nu
awk '$12!="NaN" {print $6,$12}' $file1 >> temp_fdil_nu
awk '$12!="NaN" {print $6,$9+$10+$11}'  $file1 >> temp_sigma_total_nu
awk '$12!="NaN" {print $6,$10+$11}'  $file1 >> temp_sigma_bg_nu
...
xmgrace\
	-settype xy		-block temp_sigma_d_unpol_nu	-log y 	-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_n_nu			-log y 	-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_he_nu			-log y	-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_total_nu		-log y	-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_bg_nu			-log y	-graph 0 -bxy 1:2\
	-settype xy		-block temp_fdil_nu				 		-graph 1 -bxy 1:2\
	-p /home/ellie/physics/b1/b1_rates/from_patricia/rates/scripts/cs_check_nu2.par -noask
