...
# 4 = F1d_qe
# 5 = F1d
#awk '$12!="NaN" && $3>0 {print $1,$3}'  $file2 >> temp_F1d_ie
#awk '$12!="NaN" && $4>0 {print $1,$4}'  $file2 >> temp_F1d_qe
#awk '$12!="NaN" && $5>0 {print $1,$5}'  $file2 >> temp_F1d
echo '0.012	7.044' >> temp_F1d_hermes
echo '0.032	3.427' >> temp_F1d_hermes
echo '0.063	1.929' >> temp_F1d_hermes
echo '0.128	1.018' >> temp_F1d_hermes
echo '0.248	0.496' >> temp_F1d_hermes
echo '0.452	0.161' >> temp_F1d_hermes


file2="/home/ellie/physics/b1/b1_rates/from_patricia/rates/output/rebinned-x.out"
awk '$1!="NaN" {print $2,$21}'  $file2 >> temp_F1d
#awk '$1!="NaN" {print $2,$22}'  $file2 >> temp_F1d_hermes


echo '0.0	0.0' >> temp_F1d_ie
echo '0.0	0.0' >> temp_F1d_qe
...
xmgrace\
	...
	-settype xy		-block temp_sigma_n			-log y		-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_he		-log y		-graph 0 -bxy 1:2\
	-settype xy		-block temp_sigma_li_hed	-log y		-graph 0 -bxy 1:2\
	...
	-settype xy		-block temp_lumsig_he		-log y		-graph 2 -bxy 1:2\
	-settype xy		-block temp_lumsig_heli		-log y		-graph 2 -bxy 1:2\
	-settype xy		-block temp_lumsig_li		-log y		-graph 2 -bxy 1:2\
	-settype xy		-block temp_F1d_ie				-graph 3 -bxy 1:2\
	-settype xy		-block temp_F1d_qe				-graph 3 -bxy 1:2\
	-settype xy		-block temp_F1d					-graph 3 -bxy 1:2\
	-settype xy		-block temp_F1d_hermes				-graph 3 -bxy 1:2\
	-p /home/ellie/physics/b1/b1_rates/from_patricia/rates/scripts/cs_check_hermes.par -noask
