...
# The lines below prepares temporary text files in "x,y" format that
...
awk '$1==1 && $2==1 && $6>=2.0 {print $5,$4}' $file0 > hms_cov_5
awk '$1==1 && $2==2 && $6>=2.0 {print $5,$4}' $file0 > hms_cov_6
awk '$1==1 && $2==3 && $6>=2.0 {print $5,$4}' $file0 > hms_cov_7
awk '$1==1 && $2==4 && $6>=2.0 {print $5,$4}' $file0 > hms_cov_8
...
awk '$1==2 && $2==1 && $6>=2.0  {print $5,$4}' $file0 > shms_cov_5
awk '$1==2 && $2==2 && $6>=2.0  {print $5,$4}' $file0 > shms_cov_6
awk '$1==2 && $2==3 && $6>=2.0  {print $5,$4}' $file0 > shms_cov_7
awk '$1==2 && $2==4 && $6>=2.0  {print $5,$4}' $file0 > shms_cov_8
...
xmgrace -free -settype xy -block hms_cov_1  -graph 0 -bxy 1:2 \
              ...
              -settype xy -block $file1     -graph 0 -bxy 1:7 \
              ...
              -settype xy -block $file1     -graph 1 -bxy 1:7 \
              -settype xy -block $file1     -graph 1 -bxy 1:6 \
              -p new_cov.par -noask
gracebat -hdevice EPS -printfile new_kincov.eps \
...
xmgrace -free -settype xy -block hms_cov_1  -graph 0 -bxy 1:2 \
              ...
              -settype xy -block $file1     -graph 1 -bxy 1:7 \
              -settype xy -block $file1     -graph 1 -bxy 1:6 \
              -p new_cov_DISline.par -noask
gracebat -hdevice EPS -printfile new_kincov_onlyDISline.eps \
              -settype xy -block hms_cov_1  -graph 0 -bxy 1:2 \
              -settype xy -block hms_cov_2  -graph 0 -bxy 1:2 \
              -settype xy -block hms_cov_3  -graph 0 -bxy 1:2 \
              -settype xy -block hms_cov_4  -graph 0 -bxy 1:2 \
