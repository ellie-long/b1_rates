...
#awk '$1==2 && $5!="NaN" {print $2,0,0,$4}' $file7 > temp_shms_azz_stat
...
#awk '$1==2 && $5!="NaN" {print $2,0,0,$5}' $file7 > temp_shms_stat
...
hms_scale=`awk 'BEGIN{scale = 17/('$hms_csmax'-'$hms_csmin')} END {print scale}' $file6`
...
shms_scale=`awk 'BEGIN{scale = 17/('$shms_csmax'-'$shms_csmin')} END {print scale}' $file6`
...
hmsa_scale=`awk 'BEGIN{scale = 17/('$hmsa_csmax'-'$hmsa_csmin')} END {print scale}' $file6`
...
shmsa_scale=`awk 'BEGIN{scale = 17/('$shmsa_csmax'-'$shmsa_csmin')} END {print scale}' $file6`
...
awk '$1==1 && $2==1 && $14>0 && $10>0 && $10<3 {print $10,$24,$14*'$hms_scale'+19}' $file6 > temp_hms_theta1
awk '$1==1 && $2==2 && $14>0 && $10>0 && $10<3 {print $10,$24,$14*'$hms_scale'+19}' $file6 > temp_hms_theta2
awk '$1==1 && $2==3 && $14>0 && $10>0 && $10<3 {print $10,$24,$14*'$hms_scale'+19}' $file6 > temp_hms_theta3
awk '$1==1 && $2==4 && $14>0 && $10>0 && $10<3 {print $10,$24,$14*'$hms_scale'+19}' $file6 > temp_hms_theta4
awk '$1==1 && $2==5 && $14>0 && $10>0 && $10<3 {print $10,$24,$14*'$hms_scale'+19}' $file6 > temp_hms_theta5
echo "0.0	0.0	0.0" >> temp_hms_ctheta
...
awk '$1==1 && $2==1 && $14>0 && $10>0 && $10<3 {print $10,$25,$14*'$hms_scale'+19}' $file6 > temp_hms_theta_q1
awk '$1==1 && $2==2 && $14>0 && $10>0 && $10<3 {print $10,$25,$14*'$hms_scale'+19}' $file6 > temp_hms_theta_q2
awk '$1==1 && $2==3 && $14>0 && $10>0 && $10<3 {print $10,$25,$14*'$hms_scale'+19}' $file6 > temp_hms_theta_q3
awk '$1==1 && $2==4 && $14>0 && $10>0 && $10<3 {print $10,$25,$14*'$hms_scale'+19}' $file6 > temp_hms_theta_q4
awk '$1==1 && $2==5 && $14>0 && $10>0 && $10<3 {print $10,$25,$14*'$hms_scale'+19}' $file6 > temp_hms_theta_q5
...
awk '$1==1 && $2==1 && $14>0 && $10>0 && $10<3 {print $10,$23,$14*'$hms_scale'+19}' $file6 > temp_hms_ep1
awk '$1==1 && $2==2 && $14>0 && $10>0 && $10<3 {print $10,$23,$14*'$hms_scale'+19}' $file6 > temp_hms_ep2
awk '$1==1 && $2==3 && $14>0 && $10>0 && $10<3 {print $10,$23,$14*'$hms_scale'+19}' $file6 > temp_hms_ep3
awk '$1==1 && $2==4 && $14>0 && $10>0 && $10<3 {print $10,$23,$14*'$hms_scale'+19}' $file6 > temp_hms_ep4
awk '$1==1 && $2==5 && $14>0 && $10>0 && $10<3 {print $10,$23,$14*'$hms_scale'+19}' $file6 > temp_hms_ep5
...
awk '$1==1 && $2==1 && $14>0 && $12>0 && $10>0 && $10<3 {print $10,sqrt($12),$14*'$hms_scale'+19}' $file6 > temp_hms_w1
awk '$1==1 && $2==2 && $14>0 && $12>0 && $10>0 && $10<3 {print $10,sqrt($12),$14*'$hms_scale'+19}' $file6 > temp_hms_w2
awk '$1==1 && $2==3 && $14>0 && $12>0 && $10>0 && $10<3 {print $10,sqrt($12),$14*'$hms_scale'+19}' $file6 > temp_hms_w3
awk '$1==1 && $2==4 && $14>0 && $12>0 && $10>0 && $10<3 {print $10,sqrt($12),$14*'$hms_scale'+19}' $file6 > temp_hms_w4
awk '$1==1 && $2==5 && $14>0 && $12>0 && $10>0 && $10<3 {print $10,sqrt($12),$14*'$hms_scale'+19}' $file6 > temp_hms_w5
...
#		-p /home/ellie/physics/b1/b1_rates/from_patricia/rates/scripts/b1_proj_hermes.par -noask 
#


#gracebat -hdevice PNG -printfile b1_rates_hms_shms.png \
#gracebat -hdevice EPS -printfile b1_rates_hms_shms_full.eps \
xmgrace \
		-settype xy			-block temp_model_miller		-graph 0 -bxy 1:2 \
		-settype xy			-block temp_model_nosea_mstw		-graph 0 -bxy 1:2 \
		-settype xy			-block temp_model_sea_mstw		-graph 0 -bxy 1:2 \
