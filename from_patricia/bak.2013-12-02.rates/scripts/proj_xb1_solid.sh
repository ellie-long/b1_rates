...
#awk '$1==1 {print $3,$3*$9,$3*$10/1.414}' $file3 > hms_stat
#awk '$1==2 {print $3,$3*$9,$3*$10/1.414}' $file3 > shms_stat
awk '$1==4 {print $3,0.0,$3*$10}' $file3 > shms_stat
awk '$1==4 {print $3,$3*$16}' $file3 > syst
